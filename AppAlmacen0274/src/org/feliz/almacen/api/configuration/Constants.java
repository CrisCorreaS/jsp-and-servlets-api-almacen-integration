...
public interface Constants extends Serializable{
	...
	public static final String DB_CONNECION_WEB_SERVER_DS = "database.DB_CONNECTION_WEB_SERVER_DS";
	public static final String KEY_MOD_CLI = "Mod_CLI";
	public static final boolean DEFAULT_MOD_CLI = false;
